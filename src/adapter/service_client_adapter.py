...
class ServiceClientAdapter(Client):
    ...
    def get_messages(self, max_results: int = 10) -> Iterator[Message]:
        ...
        try:
            ...
            resp = list_messages_mod.sync(self._client, max_results)
    ...
    def get_message(self, message_id: str) -> Message:
        ...
        try:
            ...
            resp = get_message_mod.sync(self._client, message_id)
        return ServiceMessage(resp)
    ...
    def delete_message(self, message_id: str) -> bool:
        ...
        try:
            ...
            try:
                ...
                res = delete_mod.sync(self._client, message_id)
    ...
    def mark_as_read(self, message_id: str) -> bool:
        ...
        try:
            ...
            try:
                ...
                res = mark_mod.sync(self._client, message_id)
            return getattr(res, "ok", True)
        except (AttributeError, RuntimeError, ValueError, TypeError):
            return False
